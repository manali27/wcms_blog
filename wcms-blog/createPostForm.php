			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<div id="main-div">
						...
						<form name="addPost-form" id="addPost-form" action="addPost.php" method="post">
                            ...
                            <div class="form-group" id="title-div">
                                ...
                                <input type="text" name="title" class="form-control input-lg" id="title" placeholder="Enter post title" />
                            ...
                            <button type="submit" class="btn btn-success btn-block" id="publish-btn">Publish</button>
